# Legends RPG: Serialization

The serialization system in legends is an implementation of the *Media Molecule* serialization
method, which I find to be very simple yet extremely powerful for implementing versioned binary files.
