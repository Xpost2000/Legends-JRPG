...
*** TODO Merge the entity_ability_database with entity_database
*** TODO Load the abilities database from abilities.txt
*** TODO (DOING)Particle System
*** TODO (DOING)My end turn is broken.
*** TODO (DOING)Item Use menu in the battle UI.
*** TODO (DOING) Combat System changes
:LOGBOOK:
...
*** TODO (DOING)Polish up the battle victory screen & Loot Table needs to reward the winner lol.
